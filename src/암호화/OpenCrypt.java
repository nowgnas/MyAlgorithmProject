...
public class OpenCrypt {
    ...
    public static String noIvParamAesEncrypt(String msg, byte[] key) throws Exception {
        SecretKeySpec skeySpec = new SecretKeySpec(key, "AES");
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
    ...
    public static String noIvParamAesDecrypt(String msg, byte[] key) throws Exception {
        SecretKeySpec skeySpec = new SecretKeySpec(key, "AES");
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(" ##### key to hex ####");
        String hexKey = byteArrayToHex(key);
        System.out.println(hexKey);
        System.out.println();


        System.out.println(" ##### encrypt with plain text ####");
        String username = aesEncrypt("lee", key);
        System.out.println("encrypt: " + username);
        System.out.println();


        System.out.println(" ##### get sha256 with plain text ####");
        String pw = new String(getSHA256("1234", "salt"));
        System.out.println("pw encrypt: " + pw);
        System.out.println();

        System.out.println("decrypt----------");
        String decryptName = aesDecrypt(username, key);
